...
## Recent Changes
- **v2.2.0** (2025-11-25): Theme system with Light/Dark modes - Background now scrolls with page (full width, no fixed), removed backdrop blur from cards for clearer background visibility. Light Theme uses subtle white overlay (rgba 255,255,255,0.06), Dark Theme uses dark overlay (rgba 0,0,0,0.35). Theme persists in localStorage. Settings page has theme selector dropdown.
